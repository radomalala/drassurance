      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-12">
          {[
            ...
            {bg:'bg-orange-100',emoji:'🔍',t:'2. Nous analysons',s:'Sous 2 heures'},
            {bg:'bg-green-100',emoji:'✅',t:'3. Vous êtes assuré',s:'Solution immédiate'},
            {bg:'bg-blue-100',emoji:'📈',t:'4. Réhabilitation',s:'Sur 3 niveaux'},
          ].map((c,i)=> (
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-left">
          ...
          <form onSubmit={onSubmit}>
            ...
            <button type="submit" className="w-full bg-urgent-red text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-red-700">🚨 URGENCE - Me rappeler maintenant</button>
          </form>
        </div>
      </div>
    </div>
